...
namespace HandofGod
{
    class C
    {
        ...
        public const int oa_t_str = 56;
        public const int oa_t_int = 57;
        public const int oa_t_dex = 58;
        public const int oa_t_wis = 59;
        public const int oa_t_con = 60;
        public const int oa_t_chr = 61;
        public const int oa_t_hps = 62;
        public const int oa_t_move = 63;
        public const int oa_t_mana = 64;
        ...
        public const int oa_spell_focus = 70; // real ID -> 70
        public const int oa_hitnsp = 71; // real ID -> 71
        //public const int oa_end = 71;
        public const int oa_speed = 72;
        public const int oa_proficiency = 73;
        public const int oa_mastery = 74;
        public const int oa_resilience = 75; 
        public const int oa_persistence = 76;                
        public const int oa_fork = 77;
        public const int oa_gainskill = 78;      
        public const int oa_lifesteal = 79;   
        public const int oa_evasion = 80;     
        public const int oa_riposte = 81;    
        public const int oa_bonus_fire = 82; 
        public const int oa_bonus_cold = 83; 
        public const int oa_bonus_elec = 84; 
        public const int oa_bonus_energy = 85; 
        public const int oa_bonus_blunt = 86; 
        public const int oa_bonus_slash = 87; 
        public const int oa_bonus_pierce = 88; 
        public const int oa_bonus_nature = 89; 
        public const int oa_bonus_chaos = 90; 
        public const int oa_bonus_psych = 91; 
        public const int oa_bonus_arcane = 92; 
        public const int oa_bonus_lumen = 93; 
        public const int oa_bonus_umbra = 94; 
        public const int oa_critical = 95; 
        public const int oa_new_str = 96; 
        public const int oa_new_dex = 97; 
        public const int oa_new_int = 98;
        public const int oa_new_wis = 99;
        public const int oa_new_con = 100;
        public const int oa_new_chr = 101;
        public const int oa_spell_modify = 102; 
        public const int oa_resistance_fire = 103;
        public const int oa_resistance_cold = 104;
        public const int oa_resistance_elec = 105;
        public const int oa_resistance_energy = 106;
        public const int oa_resistance_blunt = 107;
        public const int oa_resistance_slash = 108;
        public const int oa_resistance_pierce = 109;
        public const int oa_resistance_acid = 110;
        public const int oa_resistance_nature = 111;
        public const int oa_resistance_drain = 112; 
        public const int oa_resistance_sleep = 113; 
        public const int oa_resistance_charm = 114; 
        public const int oa_resistance_hold = 115; 
        public const int oa_resistance_chaos = 116;
        public const int oa_resistance_psych = 117;
        public const int oa_resistance_arcane = 118; 
        public const int oa_resistance_lumen = 119;
        public const int oa_resistance_umbra = 120;
        public const int oa_resistance_elem = 121;
        public const int oa_resistance_divine = 122;
        public const int oa_resistance_phys = 123;
        public const int oa_damage_done = 124;
        public const int oa_damage_taken = 125;
        public const int oa_healing_done = 126;
        public const int oa_healing_taken = 127;
        public const int oa_bonus_healing = 128; 
        public const int oa_bonus_acid = 129; 
        public const int oa_bonus_trauma = 130; 
        public const int oa_intuition = 131;
        public const int oa_lethality = 132;
        public const int oa_onhit_proc = 133; 
        public const int oa_block_chance = 134;
        public const int oa_resistance_trauma = 135;
        public const int oa_oncrit_proc = 136;
        public const int oa_onexc_proc = 137;
        public const int oa_onexcrit_proc = 138;
        public const int oa_oncrit_taken = 139;
        public const int oa_onhit_taken = 140;
        public const int oa_random_affix = 141; 
        public const int oa_specific_affix = 142; 
        public const int oa_empty_socket = 143; 
        public const int oa_filled_socket = 144; 
        public const int oa_fire_skills = 145;
        public const int oa_cold_skills = 146;
        public const int oa_elec_skills = 147;
        public const int oa_energy_skills = 148;
        public const int oa_blunt_skills = 149;
        public const int oa_slash_skills = 150;
        public const int oa_pierce_skills = 151;
        public const int oa_acid_skills = 152;
        public const int oa_nature_skills = 153;
        public const int oa_chaos_skills = 154;
        public const int oa_psych_skills = 155;
        public const int oa_arcane_skills = 156;
